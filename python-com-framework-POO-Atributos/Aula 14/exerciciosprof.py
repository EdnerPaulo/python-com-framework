...
# Classe `Produto` com atributos protegido55 `_nome`, `_preco`, `_quantidade`. Use propriedades (`@property`) para acessar esses atributos. Crie um método `aplicar_desconto(percentual)` que reduz o preço. O preço não pode ficar negativo. Teste criando produtos e aplicando descontos.
